...
public class WaterShader extends ShaderProgram {
    ...
    private final static String VERTEX_FILE = "src/zeubigame/water/waterVertex.txt";
    private final static String FRAGMENT_FILE = "src/zeubigame/water/waterFragment.txt";
