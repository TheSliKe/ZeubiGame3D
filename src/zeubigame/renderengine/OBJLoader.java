...
public class OBJLoader {
    ...
    public static RawModel laodObjModel (String filename, Loader loader){
        ...
        try {
            ...
            while(true){
                ...
                if (line.startsWith("v ")){
                    ...
                    textureArray = new float[verticles.size()*2];
                    normalArray = new  float[verticles.size()*3];
                    break;
                }
        ...
        verticesArray = new float[verticles.size() * 3];
        indicesArray = new int[indices.size()];

        int vertexPointer = 0;
        for (Vector3f vertex:verticles){
